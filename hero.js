...
class ErenTitan {
    ...
    loadAnimation() {
        ...
        // Walking
        this.animations[1] = new Animator(this.spritesheet,80,1136,55,99,8,0.3,1.5,true,true);
        // Run
        this.animations[2] = new Animator(this.spritesheet,80,1136,55,99,8,0.3,-5.2,true,true);
        // Damaged
        ...
        // Attacking
        this.attackAnim = new Animator(this.spritesheet,21,1260,74,108,4,0.3,false,false);
        // TItan attack
        this.attackAnim2 = new Animator(this.spritesheet,21,1761,164,70,6,0.3,0.5,false,false);
        // Jumping
