class SceneManager {
    constructor(game) {
        ...
        this.LEFT = 0;
        this.RIGHT = 1; 
        this.monsters = [[5,0,0,0,0],[5,2,0,0,0],[8,2,2,0,0],[10,2,2,1,0],[4,0,0,0,1]];//[[1,0,0,0,1]];//
        /**
    ...
    loadWorld() {
       ...
       // this.startingScreen();
        ...
        if(PARAMS.CHARACTER3 == true) this.game.addEntityForeground(new ErenTitan(this.game,0,0));
    ...
    update() {
        ...
        */
        ...
        this.game.entities[0].forEach(function (entity) {
            ...
            if (entity instanceof ErenTitan && (entity.finishDead == true)) {
                that.loadGame = false;
                that.clearEntities();
                PARAMS.ROUND = 1;
                that.gameOver();
