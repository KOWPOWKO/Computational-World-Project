        ...
        if (this.dead == false) {
            if (this.facing == this.RIGHT) {
                if (this.JUMPING == true && this.ATTACKING == false && this.TITAN == false) {
                    ...
                    this.attackAnim.drawFrame(this.game.clockTick,ctx,this.x - 48,this.y +35,1.2);     
                } 
                else if (this.TITAN == true) {
                    this.attackAnim2.drawFrame(this.game.clockTick,ctx,this.x - 48,this.y - 2,1.2);     
                } 
                    ...
                    if (this.state == this.WALKING) {
                        this.animations[this.state].drawFrame(this.game.clockTick,ctx,this.x-20,this.y+14,1.2);
                    } 
                    else {
                        this.animations[this.state].drawFrame(this.game.clockTick,ctx,this.x,this.y+14,1.2);
                    }
                ...
                if (this.JUMPING == true && this.ATTACKING == false && this.TITAN == false) {
                    ...
                    this.attackAnim.drawFrameReverse(this.game.clockTick,ctx,this.x-30,this.y +35,1.2); 
                } 
                else if (this.TITAN == true) {
                    this.attackAnim2.drawFrameReverse(this.game.clockTick,ctx,this.x - 48,this.y - 12,1.2);     
                } 
                else if (this.knockback) {
                    ...
                    this.animations[this.state].drawFrameReverse(this.game.clockTick,ctx,this.x-20,this.y+14,1.2);
                }
            }
        } else if (this.dead == true) {
